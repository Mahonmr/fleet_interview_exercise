...
This is an exercise that will test a candidate’s basic knowledge of Ruby on Rails. This app was build with Rails version Rails 4.2.6 and ruby version 2.0.0p247 with MySql Ver 14.14 Distrib 5.6.21  The requirements are as follows
...
Then do following on the commond line
* rake db:create
* rake db:migrate
* rails s
